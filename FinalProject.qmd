...
<<<<<<< Updated upstream
To guide our analysis, our team developed a set of research questions focused on identifying key relationships between population and pollution levels. One area of focus is how does population contribute to the pollution over a select six countries. In designing this study, our team prioritized ethical data practices by applying the FAIR (Findable, Accessible, Interoperable, Reusable) and CARE (Collective Benefit, Authority to Control, Responsibility, Ethics) principles. We considered collective benefit by ensuring our findings could have a global impact, as well as considering responsibility by avoiding selection bias. Furthermore, to promote inclusivity and neutrality in our analysis, we selected six countries representing each continent using a random name generator and excluded Antartica due to its low population. Another question our team will investigate is how specific pollutant values, like Carbon Monoxide, Ozone, Nitrogen Dioxide, and Particulate Matter, contribute to a country's overall Air Quality Index (AQI), and which pollutants have the strongest impact. Lastly, observing whether urban population percentage can have a positive or detrimental effect on pollution is essential to understanding how urbanization may shape air quality outcomes across regions. Overall, this is not an exhaustive list of questions of what our team intends to explore since there are NOT FINISHED XX
