...
\caption{\label{tab:unnamed-chunk-1}Linear Regression Summary for Pollutants impact on AQI}\\
\toprule
...
\pandocbounded{\includegraphics[keepaspectratio]{FinalProject_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{FinalProject_files/figure-pdf/unnamed-chunk-1-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{FinalProject_files/figure-pdf/fig-CountryAQI-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{FinalProject_files/figure-pdf/fig-UrbanpopulationAQI-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{FinalProject_files/figure-pdf/fig-OzoneLandAreaRelation-1.pdf}}
...
\NormalTok{    ) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
    ...
    \AttributeTok{y =} \StringTok{"Slope Measure"}
\NormalTok{  ) }\SpecialCharTok{+}
